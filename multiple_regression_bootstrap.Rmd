...
Before proceeding to bootstrap, it's great to check for multicollinearity among the predictors. This can be done using the Variance Inflation Factor (VIF):
